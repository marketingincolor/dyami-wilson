...
?>
	...
	<section id="home" class="home-hero" style="background: url( <?php bloginfo('template_directory') . '/assets/images/home/home-hero.png'; ?>) center center no-repeat;background-size:cover">
		<div class="row">
